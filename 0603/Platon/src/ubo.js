...
class Ubo_Matr{
    constructor( MatrWVP, MatrW, MatrWInv, MatrVP, MatrV, CamLoc, CamAt, CamRight, CamUp, CamDir, ProjDistFarTimeLocal, TimeGlobalDeltaGlobalDeltaLocal, ProjectSize){
...
class UBO{
    ...
    static add(Ubo, name) {
        ...
        if (name === "BaseData") {
            gl.bufferData(
                gl.UNIFORM_BUFFER,
                new Float32Array([..._matr4.toarr(Ubo.MatrWVP), ..._matr4.toarr(Ubo.MatrW), ..._matr4.toarr(Ubo.MatrWInv), ..._matr4.toarr(Ubo.MatrVP), ..._matr4.toarr(Ubo.MatrV),
                     ..._vec3.vec3(Ubo.CamLoc), 1, ..._vec3.vec3(Ubo.CamAt), 1, ..._vec3.vec3(Ubo.CamRight), 1, ..._vec3.vec3(Ubo.CamUp), 1, ..._vec3.vec3(Ubo.CamDir), 1,
                     ..._vec3.vec3(Ubo.ProjDistFarTimeLocal), 1, ..._vec3.vec3(Ubo.TimeGlobalDeltaGlobalDeltaLocal), 1, ..._vec3.vec3(Ubo.ProjectSize), 1]),
                gl.STATIC_DRAW
              );        
        }
        if (name === "Material"){
            let x = [..._vec3.vec3(Ubo.Ka), 1, ..._vec3.vec3(Ubo.Kd), 1, ..._vec3.vec3(Ubo.Ks), 1, Ubo.Ph, Ubo.Trans, 1, 1, ...Ubo.Tex]; 
            gl.bufferData(
                gl.UNIFORM_BUFFER,
                new Float32Array([..._vec3.vec3(Ubo.Ka), 1, ..._vec3.vec3(Ubo.Kd), 1, ..._vec3.vec3(Ubo.Ks), 1, Ubo.Ph, Ubo.Trans, 1, 1, ...Ubo.Tex]),
                gl.STATIC_DRAW
              );  
        }
    ...
    static update(id, name_cell, cell_data){
        ...
        if (Ubos[id].name === "BaseData"){
            ...
            let x = new Float32Array([..._matr4.toarr(Ubos[id].ubo.MatrWVP),
             ..._matr4.toarr(Ubos[id].ubo.MatrW), ..._matr4.toarr(Ubos[id].ubo.MatrWInv), ..._matr4.toarr(Ubos[id].ubo.MatrVP), ..._matr4.toarr(Ubos[id].ubo.MatrV),
            ..._vec3.vec3(Ubos[id].ubo.CamLoc), 1, ..._vec3.vec3(Ubos[id].ubo.CamAt), 1, ..._vec3.vec3(Ubos[id].ubo.CamRight), 1, ..._vec3.vec3(Ubos[id].ubo.CamUp), 1, ..._vec3.vec3(Ubos[id].ubo.CamDir), 1,
   ..._vec3.vec3(Ubos[id].ubo.ProjDistFarTimeLocal), 1, ..._vec3.vec3(Ubos[id].ubo.TimeGlobalDeltaGlobalDeltaLocal), 1, ..._vec3.vec3(Ubos[id].ubo.ProjectSize), 1]);
