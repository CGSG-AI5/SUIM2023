  ...
  if (flag == 0) {
    ...
    Worl = _matr4.mulmatr(
      _matr4.mulmatr(
        ...
        _matr4.mulmatr(
          _matr4.rotateX(R2D(Math.acos(V / -V0))),
          _matr4.rotateY(AzimuthDrop)
        )
      ),
      _matr4.translate(_vec3.add(_vec3.set(-Z, H, -S), Pos0))
    );
    if (H < -10 || S > 40) {
      flag = 2;
    }
